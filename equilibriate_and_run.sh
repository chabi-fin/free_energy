...
do
	...
	# Energy Minimization
	gmxs grompp -f $MDP/em_steep_$lambda.mdp -c $home/initial.gro -p $home/topol.top -o em_$lambda.tpr -maxwarn 1 -nobackup
	...
	echo "Density" | gmx194 energy -f npt2_$lambda.edr -o density1_$lambda.xvg -nobackup
